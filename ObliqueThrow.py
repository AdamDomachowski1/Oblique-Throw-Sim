...
class object:
    ...
    def __init__(self,acceleration,timeofengine,startangle,factor_k):
        self.velocity = 0
        self.list_velx.append(math.cos(startangle)*self.velocity)
        self.list_vely.append(math.sin(startangle)*self.velocity)
...
# Main -------------------------
acc_0 = turtle.textinput("Datas to simulation", "Enter acceleration generated by engine (m/s^2), if need use [.] instead [,]")
if int(acc_0) > 1000:
    while int(acc_0) > 1000:
        acc_0 = turtle.textinput("Datas to simulation", "Enter acceleration generated by engine lower than 1000 (m/s^2), if need use [.] instead [,]")
...
if int(angle) > 90:
    while int(angle) >= 91:
        angle = turtle.textinput("Datas to simulation", "Enter start angle max 90 (degrees)")
